...
#This is a copy of the relay code used in the bat file for ease of testing
#Takes command line arguements instead of user input
...
#'main'
dirAddress = str(sys.argv[1])
serverPort = int(sys.argv[2])
print('Client IPv4 Address: ' + dirAddress)
